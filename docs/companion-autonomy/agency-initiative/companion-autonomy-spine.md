...
| --- | --- |
| Relationship memory, living context, governed Surface selection | Agency, presence, and relationship contracts |
| Attention metabolism, urge maturation, initiative gating, expression choice | Agency, presence, and relationship contracts |
| Runtime control plane, posture, authority, staleness, inspectability, audit | System architecture contracts |
| Runtime safety substrate for auth, browser sessions, guardrails, backpressure | System architecture contracts |

The map-level entry points are the agency, presence, relationship, and
runtime-system architecture maps.
