...
> Status: Implemented contract and regression slice. Slow semantic evals remain
...
The current regression slice runs through the root unit lane because it uses
