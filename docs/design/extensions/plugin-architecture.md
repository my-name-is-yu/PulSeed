...
The default behavior has zero autonomy. "Which plugins to use" is entirely determined by the user. However, "when to call plugins" is decided by PulSeed within the core loop.
