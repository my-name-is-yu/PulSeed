...
| Runtime auth and guardrails | `docs/design/infrastructure/runtime-auth-browser-guardrails.md`, `src/runtime/control/`, `src/runtime/guardrails/` | Auth handoffs, browser sessions, guardrails, and backpressure are hard readiness inputs and fail-closed blockers. |
