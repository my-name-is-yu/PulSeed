...
> Related: `plugin-architecture.md`, `reporting.md`, `daemon-client-architecture.md`, `docs/design/core/loop/observation.md`, `docs/design/execution/context/data-source.md`
