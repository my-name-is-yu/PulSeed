...
| Runtime auth and guardrails | `docs/design/infrastructure/runtime/runtime-auth-browser-guardrails.md`, `src/runtime/control/`, `src/runtime/guardrails/` | Auth handoffs, browser sessions, guardrails, and backpressure are hard readiness inputs and fail-closed blockers. |
...
| Runtime control | `docs/design/infrastructure/runtime/runtime-control-plane.md`, `src/runtime/control/runtime-control-service.ts`, `src/runtime/store/`, `src/runtime/session-registry/` | Runtime control owns admission, staleness, authority, visibility, control, and audit for action-bearing operations. |
