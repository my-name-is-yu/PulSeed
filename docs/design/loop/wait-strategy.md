...
> Implementation alignment: the wait-strategy model applies to the current DurableLoop redesign. Detailed ownership is under `src/orchestrator/strategy/`, `src/orchestrator/loop/`, and `src/platform/drive/`.
