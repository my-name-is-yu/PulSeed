...
> Implementation alignment: the risk model remains relevant across the current `src/orchestrator/`, `src/platform/`, and `src/base/` layout. Some implementation-location bullets are historical examples; current source owners take precedence.
