...
> Scope: Runtime auth, browser session, and guardrail design rationale.
...
The design should be implemented as separate, reviewable changes:
...
Do not implement GUI-specific behavior in this sequence. GUI work should
