...
The default behavior provides six read-only self-knowledge tools. The extended behavior adds seven write/mutation tools (see extended behavior section below). Each tool maps to a specific data source within PulSeed.
...
**Use cases**: "What is PulSeed?", "How does the DurableLoop work?", "What can you do?", "Explain your architecture."
...
## extended behavior: Mutation Tools

The extended behavior adds 7 write/mutation tools that allow the LLM to modify PulSeed state on behalf of the user.
