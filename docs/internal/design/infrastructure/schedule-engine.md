...
> Related: `plugin-architecture.md`, `reporting.md`, `daemon-client-architecture.md`, `docs/internal/design/core/observation.md`, `docs/internal/design/execution/data-source.md`
