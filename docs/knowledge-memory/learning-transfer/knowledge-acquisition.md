...
Do not expect to obtain complete knowledge in a single investigation. Leverage the self-correcting nature of the DurableLoop to deepen knowledge gradually.
...
How acquired knowledge feeds back into each step of the DurableLoop.
...
|-----------|--------------------------|
| Knowledge acquisition is part of goal pursuit | Triggered naturally within the DurableLoop, not as a separate learning mode |
