...
[CLI Reference](../command-reference/cli-commands/cli.md). For current package version and release
...
- product-completion boundary checks through
  [Product Completion Scenario Matrix](../../product-direction/product-boundaries/completion-matrix.md)
...
- design contracts under cluster maps such as `docs/runtime-architecture/` and `docs/companion-autonomy/`
- product design direction under `docs/product-direction/`
...
[Product Completion Scenario Matrix](../../product-direction/product-boundaries/completion-matrix.md) is the
