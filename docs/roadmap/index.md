...
Pages in this section may describe product intent beyond the current
implementation. They must not be treated as current behavior unless they
explicitly link back to current code-backed docs.
