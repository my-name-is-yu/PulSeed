...
const ALLOWLIST_RULES_BY_ID = new Map(Object.entries({
  ...
  "state-manager-capability-dependency-typed-route": ["capability-dependencies-json-state"],
...
const PATH_ALLOWLIST = [
  ...
  allow({
    id: "state-manager-capability-dependency-typed-route",
    pattern: /(^|\/)src\/base\/state\/state-manager\.ts$/,
    category: CATEGORY.MIGRATION_ONLY_INPUT,
    reason: "StateManager raw compatibility routes the legacy capability_dependencies.json logical path to the typed capability dependency store",
    owner: "Capability dependency typed registry / control DB capability dependency table",
  }),
  allow({
