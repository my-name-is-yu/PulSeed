...
export {
  SurfaceProtocolSchemaVersion,
  SurfaceProjectionSchema,
  SurfaceNormalViewSchema,
  SurfaceOperatorDebugViewSchema,
  SurfacePanelSchema,
  SurfaceArtifactCardSchema,
  SurfaceActionSchema,
  SurfaceActionBindingSchema,
  SurfaceApprovalPromptSchema,
  SurfaceMemorySummarySchema,
  SurfaceStatusSummarySchema,
  SurfaceDeliveryProjectionSchema as UnifiedSurfaceDeliveryProjectionSchema,
  ...
  operatorRuntimeGraphRef,
  projectionRefFromGroundingSurface,
  projectionRefFromCompanionAction,
  deliveryFromAttentionSurfaceProjection,
  projectTextSurface,
...
export type {
  SurfaceProjection,
  SurfaceNormalView,
  SurfaceOperatorDebugView,
  SurfacePanel,
  SurfaceArtifactCard,
  SurfaceAction,
  SurfaceActionBinding,
  SurfaceApprovalPrompt,
  SurfaceMemorySummary,
  SurfaceStatusSummary,
  SurfaceDeliveryProjection as UnifiedSurfaceDeliveryProjection,
  SurfaceKind,
  SurfaceView,
  SurfaceActionKind,
  SurfaceActionBindingValidationResult,
} from "./runtime/surface-projection-protocol.js";
...
export {
  ResidentRuntimeCapabilityAuthorityScopeSchema,
  ResidentRuntimeCapabilityChannelSchema,
  ResidentRuntimeCapabilityKindSchema,
  ResidentRuntimeCapabilitySchema,
  ResidentRuntimeConnectionStatusSchema,
  ResidentRuntimeEnvironmentSchema,
  ResidentRuntimeIdentitySchema,
  ResidentRuntimeInterfaceSnapshotSchema,
  RuntimeApprovalChannelContractSchema,
  RuntimeCapabilityDiscoverySchema,
  RuntimeCommandChannelContractSchema,
  RuntimeCommandDispatchStateSchema,
  RuntimeConnectionStatusSnapshotSchema,
  RuntimeDevConnectorProjectionSchema,
  RuntimeEventStreamContractSchema,
  RuntimeEventStreamEventRefSchema,
  RuntimeStaleOfflineHandlingSchema,
  buildResidentRuntimeIdentity,
  buildResidentRuntimeInterfaceSnapshot,
  deriveRuntimeConnectionStatus,
  projectDevConnectorRuntimeInterface,
} from "./runtime/resident-runtime-interface.js";
export type {
  BuildResidentRuntimeIdentityInput,
  BuildResidentRuntimeInterfaceSnapshotInput,
  DeriveRuntimeConnectionStatusInput,
  ResidentRuntimeCapability,
  ResidentRuntimeCapabilityAuthorityScope,
  ResidentRuntimeCapabilityChannel,
  ResidentRuntimeCapabilityKind,
  ResidentRuntimeConnectionStatus,
  ResidentRuntimeEnvironment,
  ResidentRuntimeIdentity,
  ResidentRuntimeInterfaceSnapshot,
  RuntimeApprovalChannelContract,
  RuntimeCapabilityDiscovery,
  RuntimeCommandChannelContract,
  RuntimeCommandDispatchState,
  RuntimeConnectionStatusSnapshot,
  RuntimeDevConnectorProjection,
  RuntimeEventStreamContract,
  RuntimeEventStreamEventRef,
  RuntimeStaleOfflineHandling,
} from "./runtime/resident-runtime-interface.js";
export {
