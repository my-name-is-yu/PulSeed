...
const STATELESS_USAGE_HELP_ROUTES = [
  ["approval"],
  ["approval", "list"],
  ["capability"],
  ["capability", "list"],
  ...
  ["profile", "proposal", "inspect"],
  ["profile", "proposal", "approve"],
  ["profile", "proposal", "reject"],
  ...
  ["runtime", "evidence"],
  ["runtime", "postmortem"],
  ["runtime", "experiment-queues"],
  ["runtime", "experiment-queue"],
  ["runtime", "budgets"],
  ["runtime", "budget"],
  ["runtime", "dream-review"],
  ["runtime", "proactive-quality"],
  ["runtime", "proactive-calibration"],
  ["runtime", "resident-activation"],
  ["runtime", "peer-initiative-capability"],
  ["runtime", "attention-continuity"],
  ["runtime", "cognition-replay"],
  ["runtime", "situation-frame"],
  ["runtime", "initiative-trace"],
  ["runtime", "attention-state"],
  ["runtime", "intervention-decision"],
  ["runtime", "capability-decision"],
  ["runtime", "capability", "explain"],
  ["runtime", "runtime-graph"],
  ["runtime", "graph", "explain"],
  ["runtime", "event-log", "rebuild"],
  ["runtime", "replay"],
  ["runtime", "memory-provenance"],
  ["runtime", "proactive-feedback"],
  ["schedule"],
  ["schedule", "list"],
  ["schedule", "show"],
  ["schedule", "get"],
...
function isStatelessUsageHelpRoute(route: readonly string[]): boolean {
  return route.length > 0
    && STATELESS_USAGE_HELP_ROUTES.some(
      (knownRoute) => knownRoute.length === route.length
        && knownRoute.every((token, index) => route[index] === token),
    );
}
...
function isStatelessUsageHelpRequest(argv: readonly string[]): boolean {
  ...
  const helpOptionIndex = args.findIndex((arg) => arg === "--help" || arg === "-h");
