...
Usage:
  ...
  pulseed runtime event-log rebuild [--dry-run] [--trace <id>] [--json]  Rebuild/apply event-log projections
  pulseed runtime replay --trace <trace-id> [--json]  Replay/explain one runtime trace
