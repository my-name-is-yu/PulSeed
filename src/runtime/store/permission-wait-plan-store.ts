...
export const PermissionWaitPlanCapabilityFactsSchema = z.object({
  ...
  capability_provider_kind: z.string().min(1).optional(),
  capability_provider_ref: z.string().min(1).optional(),
  capability_operation_kind: z.string().min(1).optional(),
  capability_side_effect_profile: z.string().min(1).optional(),
  capability_readiness_state: z.string().min(1).optional(),
  capability_approval_fingerprint: z.string().min(1).optional(),
  capability_admission_id: z.string().min(1).optional(),
  capability_admission_status: z.string().min(1).optional(),
